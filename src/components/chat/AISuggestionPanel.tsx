  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="rounded-2xl rounded-tr-sm border border-[#BEFF50] bg-white px-4 py-3 shadow-sm">
        <p className="whitespace-pre-wrap text-[16px] md:text-[14px] text-foreground">
          {suggestedText}
        </p>
        <div className="mt-3 flex flex-wrap items-center gap-2 border-t border-border pt-3">
          <Button
            ...
            disabled={isDisabled}
            aria-label="Editar"
            className="h-9 gap-1.5 rounded-full border-border px-4 text-[16px] md:text-[14px] font-normal"
          >
          ...
          <Button
            ...
            aria-label="Enviar"
            className="h-9 gap-1.5 rounded-full bg-black px-4 text-[16px] md:text-[14px] text-white hover:bg-black/90"
          >
