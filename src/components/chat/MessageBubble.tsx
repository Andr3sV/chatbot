      ...
      <div className="flex w-full gap-2">
        <Avatar className="h-8 w-8 shrink-0">
          <AvatarImage
            ...
            alt=""
          />
          <AvatarFallback className="bg-pink-100 text-[16px] md:text-[14px] text-pink-700">
            {message.sender === "client" ? "U" : "B"}
          </AvatarFallback>
        </Avatar>
        <div className="min-w-0 flex-1">
          <p className="whitespace-pre-wrap break-words text-[16px] md:text-[14px] text-foreground">
            {message.content}
          </p>
    ...
    return (
      ...
      >
        ...
        >
          ...
          <span className="mt-1 block text-[16px] md:text-[14px] text-muted-foreground">
            {format(message.timestamp, "h:mm a", { locale: es })}
          </span>
        </div>
      </div>
  ...
  if (channel === "llamadas") {
    return (
      <div className="flex w-full flex-col gap-0.5">
        <span className="text-[16px] md:text-[14px] font-medium text-muted-foreground">
          {speakerLabel}:
        </span>
        <p className="whitespace-pre-wrap break-words font-mono text-[16px] md:text-[14px] text-foreground">
          {message.content}
        </p>
        <span className="text-[16px] md:text-[14px] text-muted-foreground">
      ...
      >
        {!isClient && message.sender === "ai" && (
          <div className="flex items-center gap-3 py-2">
            ...
            <span className="text-[16px] md:text-[14px] font-medium text-foreground">
          ...
          {isPending && conversationId && onEditSuggestion && (
            <div className="mt-3 flex flex-col gap-2 border-t border-border pt-3">
              <Button
                ...
                aria-label="Enviar"
                className="h-10 w-full justify-center gap-1.5 rounded-lg bg-black text-[16px] md:text-[14px] text-white hover:bg-black/90"
              >
              ...
              <Button
                ...
                aria-label="Editar"
                className="h-10 w-full justify-center gap-1.5 rounded-lg border-border text-[16px] md:text-[14px] font-normal"
              >
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="flex items-center gap-1.5 text-[16px] md:text-[14px] text-muted-foreground">
            {isPending
              ? (
                <>
