        ...
        <div className="max-w-4xl mx-auto flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-foreground/70">
              Añade imagen, contexto y fecha de publicación
            </p>
          </div>
        </div>
      </header>
      ...
      <div className="flex-1 px-4 py-6 lg:px-8 lg:py-8 max-w-xl mx-auto w-full">
        ...
        <label className="block mb-4">
          ...
          <textarea
            ...
            placeholder="Describe el contexto o ideas para esta propuesta..."
            className="w-full min-h-[120px] rounded-xl border border-border bg-white px-4 py-3 text-sm text-foreground placeholder:text-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
            rows={4}
          />
        </label>
        ...
        <label className="block mb-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-xl border border-border bg-white pl-10 pr-4 py-3 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
            />
          </div>
        </label>
